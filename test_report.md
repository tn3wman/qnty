...
2. $\frac{\sin(\angle(\vec{F_1}, \vec{F_R}))}{|\vec{F_2}|} = \frac{\sin(0.7853981633974483)}{|\vec{F_R}|}$
...
$$
\begin{aligned}
|\vec{F_R}| &= \sqrt{(450.0)^2 + (700.0)^2 - 2(450.0)(700.0)\cos(1^{\circ})} \\
&= 497.0\ \text{N} \\
\end{aligned}
$$
...
$$
\begin{aligned}
\angle(\vec{F_1}, \vec{F_R}) &= \sin^{-1}(700.0 \cdot \frac{\sin(1^{\circ})}{497.0}) \\
&= 95.2^{\circ} \\
\end{aligned}
$$
