...
class TestVectorMagnitudeIn:
    ...
    def test_magnitude_in_with_string_unit(self):
        ...
        v = _Vector(1000, 0, 0, unit=LengthUnits.meter)
    ...
    def test_magnitude_in_with_unit_object(self):
        ...
        v = _Vector(3, 4, 0, unit=LengthUnits.meter)
    ...
    def test_magnitude_in_3d_vector(self):
        ...
        v = _Vector(3, 4, 12, unit=LengthUnits.meter)
...
class TestForceVectorMagnitudeIn:
    ...
    def test_magnitude_in_polar_construction(self):
        ...
        F = _Vector(magnitude=1000, angle=45, unit="N")
    ...
    def test_magnitude_in_replaces_manual_conversion(self):
        ...
        F = _Vector(magnitude=500, angle=30, unit="lbf")
...
class TestForceVectorAngleIn:
    ...
    def test_angle_in_unit_conversion(self):
        ...
        F = _Vector(magnitude=100, angle=45, unit="N")
    ...
    def test_angle_in_replaces_manual_conversion(self):
        ...
        F = _Vector(magnitude=100, angle=60, unit="N")

        # Old way (manual)
        angle_ref = _Vector.parse_wrt("cw:+x", F.coordinate_system)
    ...
    def test_angle_in_combined_unit_and_reference(self):
        ...
        F = _Vector(magnitude=100, angle=30, unit="N", angle_unit="degree")
...
class TestForceVectorWithMethods:
    ...
    def test_with_magnitude_unit(self):
        ...
        F1 = _Vector(magnitude=1000, angle=45, unit="N")
    ...
    def test_with_angle_unit(self):
        ...
        F1 = _Vector(magnitude=100, angle=45, unit="N", angle_unit="degree")
    ...
    def test_with_angle_reference(self):
        ...
        F1 = _Vector(magnitude=100, angle=45, unit="N")
...
class TestForceVectorIsClose:
    ...
    def test_is_close_default_tolerances(self):
        ...
        F1 = _Vector(magnitude=100, angle=45, unit="N")
        F2 = _Vector(magnitude=100.00001, angle=45.001, unit="N")
    ...
    def test_is_close_strict_magnitude_tolerance(self):
        ...
        F1 = _Vector(magnitude=100, angle=45, unit="N")
        F2 = _Vector(magnitude=100.1, angle=45, unit="N")
    ...
    def test_is_close_strict_angle_tolerance(self):
        ...
        F1 = _Vector(magnitude=100, angle=45, unit="N")
        F2 = _Vector(magnitude=100, angle=45.1, unit="N")
    ...
    def test_is_close_handles_different_units(self):
        ...
        F2 = _Vector(magnitude=224.809, angle=45, unit="lbf")
    ...
    def test_is_close_component_mode(self):
        ...
        F1 = _Vector(x=100, y=100, unit="N")
        F2 = _Vector(x=100.001, y=100.001, unit="N")
    ...
    def test_is_close_angle_wraparound(self):
        ...
        F1 = _Vector(magnitude=100, angle=1, unit="N")
        F2 = _Vector(magnitude=100, angle=359, unit="N")
...
class TestForceVectorEquality:
    ...
    def test_equality_same_values(self):
        ...
        F1 = _Vector(magnitude=100, angle=45, unit="N")
        F2 = _Vector(magnitude=100, angle=45, unit="N")

        assert F1 == F2

    def test_equality_different_construction(self):
        """Test equality for forces constructed differently but with same values."""
        F1 = _Vector(magnitude=500, angle=math.degrees(math.atan2(4, 3)), unit="N")
        F2 = _Vector(x=300, y=400, unit="N")
    ...
    def test_equality_unknown_forces(self):
        ...
        F1 = _Vector.unknown("F1")
        F2 = _Vector.unknown("F2")
    ...
    def test_inequality_different_magnitude(self):
        ...
        F1 = _Vector(magnitude=100, angle=45, unit="N")
        F2 = _Vector(magnitude=200, angle=45, unit="N")
    ...
    def test_inequality_different_angle(self):
        ...
        F1 = _Vector(magnitude=100, angle=45, unit="N")
        F2 = _Vector(magnitude=100, angle=90, unit="N")
...
class TestIntegrationExamples:
    ...
    def test_compare_forces_in_different_units(self):
        ...
        F1 = _Vector(magnitude=5000, angle=30, unit="N")
        # 5000 N ≈ 1124.045 lbf
        F2 = _Vector(magnitude=1124.045, angle=30, unit="lbf")
    ...
    def test_verify_force_components_clean_api(self):
        ...
        F = _Vector(magnitude=500, angle=53.13, unit="lbf")  # 3-4-5 triangle
