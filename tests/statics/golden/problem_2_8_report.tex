...
\begin{enumerate}
\item $\displaystyle \frac{|\vv{F_{2v}}|}{\sin(\angle(\vv{F_{2u}}, \vv{F_R}))} = \frac{\magn{\vv{F_2}}}{\sin(\angle(\vv{F_{2v}}, \vv{F_{2u}}))}$
\item $\displaystyle \frac{|\vv{F_{2u}}|}{\sin(\angle(\vv{F_{2v}}, \vv{F_R}))} = \frac{\magn{\vv{F_2}}}{\sin(\angle(\vv{F_{2v}}, \vv{F_{2u}}))}$
\end{enumerate}

\section{Step-by-Step Solution}

\vspace{0.2em}
\noindent\hspace{1em}\textbf{Step 1: Solve for $|\vv{F_{2v}}|$ using Eq 1}
\vspace{0.1em}

\begin{adjustwidth}{2em}{}
\vspace{-0.8em}
\begin{flalign*}
\quad \magn{\vv{F_{2v}}} &= 6000.0\ \text{N} \cdot \frac{\sin(30.0^{\circ})}{\sin(75.0^{\circ})} && \\
\quad &= 3105.8\ \text{N} &&
\end{flalign*}
\vspace{-0.8em}
\end{adjustwidth}
...
\vspace{0.2em}
\noindent\hspace{1em}\textbf{Step 2: Solve for $|\vv{F_{2u}}|$ using Eq 2}
\vspace{0.1em}

\begin{adjustwidth}{2em}{}
\vspace{-0.8em}
\begin{flalign*}
\quad \magn{\vv{F_{2u}}} &= 6000.0\ \text{N} \cdot \frac{\sin(75.0^{\circ})}{\sin(75.0^{\circ})} && \\
\quad &= 6000.0\ \text{N} &&
\end{flalign*}
\vspace{-0.8em}
\end{adjustwidth}
...
\midrule
\endhead
$\vv{F_{2u}}$ & 6000.0 & 0.0 & +u \\
$\vv{F_{2v}}$ & -3105.8 & 0.0 & +v \\
\bottomrule
\end{longtable}
