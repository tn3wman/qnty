...
\item $\displaystyle \frac{\sin(\angle(\vv{F_R}, \vv{F_1}))}{\magn{\vv{F_2}}} = \frac{\sin(\angle(\vv{F_2}, \vv{F_1}))}{\magn{\vv{F_1}}}$
\end{enumerate}

\section{Step-by-Step Solution}

\vspace{0.2em}
\noindent\hspace{1em}\textbf{Step 1: Solve for $\magn{\vv{F_1}}$ using Eq 1}
\vspace{0.1em}
...
\vspace{0.2em}
\noindent\hspace{1em}\textbf{Step 2: Solve for $\angle(\vv{F_R}, \vv{F_1})$ using Eq 2}
\vspace{0.1em}

\begin{adjustwidth}{2em}{}
\vspace{-0.8em}
\begin{flalign*}
\quad \angle(\vv{F_R}, \vv{F_1}) &= \sin^{-1}(700.0\ \text{N} \cdot \frac{\sin(105.0^{\circ})}{959.8\ \text{N}}) && \\
\quad &= 44.8^{\circ} &&
\end{flalign*}
\vspace{-0.8em}
\end{adjustwidth}
...
\vspace{0.2em}
\noindent\hspace{1em}\textbf{Step 3: Solve for $\angle(\vv{x}, \vv{F_1})$ with respect to +x}
\vspace{0.1em}
