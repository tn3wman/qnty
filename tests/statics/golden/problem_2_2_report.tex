...
\item $\displaystyle \frac{\sin(\angle(\vv{F_R}, \vv{F_1}))}{\magn{\vv{F_2}}} = \frac{\sin(\angle(\vv{F_2}, \vv{F_R}))}{\magn{\vv{F_1}}}$
\end{enumerate}
...
\vspace{-0.8em}
\begin{flalign*}
\quad \angle(\vv{F_2}, \vv{F_R}) &= \magn{\angle(\vv{-x}, \vv{F_2}) + \angle(\vv{x}, \vv{F_R})} && \\
\quad &= \magn{15^{\circ} + 90^{\circ}} && \\
\quad &= 105^{\circ} &&
\end{flalign*}
\vspace{-0.8em}
\end{adjustwidth}
...
\vspace{-0.8em}
\begin{flalign*}
\quad \magn{\vv{F_1}} &= \sqrt{(700)^2 + (500)^2 - 2(700)(500)\cos(105^{\circ})} && \\
\quad &= 959.8 N &&
\end{flalign*}
\vspace{-0.8em}
\end{adjustwidth}
...
\vspace{0.2em}
\noindent\hspace{1em}\textbf{Step 3: Solve for $\angle(\vv{F_R}, \vv{F_1})$ using Eq 2}
\vspace{0.1em}

\begin{adjustwidth}{2em}{}
\vspace{-0.8em}
\begin{flalign*}
\quad \angle(\vv{F_R}, \vv{F_1}) &= \sin^{-1}(700.0 \cdot \frac{\sin(105^{\circ})}{959.8}) && \\
\quad &= 44.8^{\circ} &&
\end{flalign*}
\vspace{-0.8em}
\end{adjustwidth}
...
\vspace{-0.8em}
\begin{flalign*}
\quad \angle(\vv{x}, \vv{F_1}) &= \angle(\vv{x}, \vv{F_R}) - \angle(\vv{F_R}, \vv{F_1}) && \\
...
\midrule
\endhead
$\vv{F_1}$ & 676.1 & 681.2 & 959.8 & 45.2 & +x \\
\bottomrule
\end{longtable}
