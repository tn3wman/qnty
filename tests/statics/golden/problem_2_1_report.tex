...
\begin{tikzpicture}[scale=1]
  ...
  \draw[vector,vec_f1] (A) -- (B) node[below right,pos=1] {$\vv{F_1} = 450\,\text{N}$};
...
\begin{tikzpicture}[scale=1]
  ...
  \draw[vector,vec_fr] (A) -- (D) node[pos=0.5,above right] {$\vv{F_R} = 497\,\text{N}$};

  % Draw interior angle arc (angle between F1 and F2)
  % The interior angle is 45°, drawn as an arc spanning that angle from F1.
  \draw[orange,thick] (0.000,0.000) ++(60.0:1.398) arc (60.0:105.0:1.398) node[midway,above] {$45^\circ$};
...
\vspace{-0.8em}
\begin{flalign*}
\quad \angle(\vv{F_1}, \vv{F_2}) &= \magn{\angle(\vv{x}, \vv{F_1}) - \angle(\vv{-x}, \vv{F_2})} && \\
\quad &= \magn{60^{\circ} - 15^{\circ}} && \\
\quad &= 45^{\circ} &&
\end{flalign*}
\vspace{-0.8em}
\end{adjustwidth}
...
\vspace{-0.8em}
\begin{flalign*}
\quad \magn{\vv{F_R}} &= \sqrt{(450.0\ \text{N})^2 + (700.0\ \text{N})^2 - 2(450.0\ \text{N})(700.0\ \text{N})\cos(45.0^{\circ})} && \\
\quad &= 497.0\ \text{N} &&
\end{flalign*}
\vspace{-0.8em}
\end{adjustwidth}
...
\vspace{-0.8em}
\begin{flalign*}
\quad \angle(\vv{F_1}, \vv{F_R}) &= \sin^{-1}(700.0\ \text{N} \cdot \frac{\sin(45.0^{\circ})}{497.0\ \text{N}}) && \\
\quad &= 95.2^{\circ} &&
\end{flalign*}
\vspace{-0.8em}
\end{adjustwidth}
