...
\vspace{-0.8em}
\begin{flalign*}
\quad \magn{\vv{F_{AC}}} &= 500.0\ \text{N} \cdot \frac{\sin(45.0^{\circ})}{\sin(75.0^{\circ})} && \\
\quad &= 366.0\ \text{N} &&
\end{flalign*}
\vspace{-0.8em}
\end{adjustwidth}
...
\vspace{-0.8em}
\begin{flalign*}
\quad \magn{\vv{F_{AB}}} &= 500.0\ \text{N} \cdot \frac{\sin(60.0^{\circ})}{\sin(75.0^{\circ})} && \\
\quad &= 448.3\ \text{N} &&
\end{flalign*}
\vspace{-0.8em}
\end{adjustwidth}
...
\midrule
\endhead
$\vv{F_{AB}}$ & 448.3 & -45.0 & -y \\
$\vv{F_{AC}}$ & 366.0 & -30.0 & +x \\
\bottomrule
\end{longtable}
