...
class TestForceVectorWithAngleReference:
    ...
    def test_force_with_standard_reference(self):
        ...
        # 30° CCW from +x
        force = ForceVector(magnitude=100, angle=30, unit="N", name="F")
    ...
    def test_force_with_cw_from_x_reference(self):
        ...
        ref = AngleReference.from_axis("+x", direction="clockwise")
        force = ForceVector(magnitude=100, angle=30, unit="N", name="F", angle_reference=ref)
    ...
    def test_force_with_ccw_from_y_reference(self):
        ...
        force = ForceVector(magnitude=100, angle=45, unit="N", name="F", angle_reference=ref)
    ...
    def test_problem_2_6_angle_reference(self):
        ...
        force_result = ForceVector(magnitude=8026, angle=1.22, unit="N", name="F_R", angle_reference=ref_cw_from_u)
    ...
    def test_unknown_force_with_angle_reference(self):
        ...
        ref = AngleReference.from_axis("+x", direction="clockwise")
        force = ForceVector.unknown("F", angle=30, angle_unit="degree", angle_reference=ref)
    ...
    def test_angle_reference_preservation_in_unknown(self):
        ...
        ref = AngleReference.from_axis("+y", direction="clockwise")
        force = ForceVector.unknown("F", angle=45, angle_reference=ref)
...
class TestForceVectorWrtParameter:
    ...
    def test_wrt_standard(self):
        ...
        F1 = ForceVector(magnitude=100, angle=30, unit="N", wrt="+x")
    ...
    def test_wrt_clockwise_from_x(self):
        ...
        F2 = ForceVector(magnitude=100, angle=30, unit="N", wrt="cw:+x")
    ...
    def test_wrt_with_coordinate_system_axis(self):
        ...
        F6 = ForceVector(magnitude=100, angle=30, unit="N", wrt="u", coordinate_system=uv_system)
    ...
    def test_wrt_cw_from_custom_axis(self):
        ...
        F7 = ForceVector(magnitude=100, angle=30, unit="N", wrt="cw:v", coordinate_system=uv_system)
    ...
    def test_wrt_unknown_force(self):
        ...
        F8 = ForceVector.unknown("F", angle=30, wrt="cw:+x")
    ...
    def test_wrt_and_angle_reference_conflict(self):
        ...
        with pytest.raises(ValueError, match="Cannot specify both"):
            ForceVector(magnitude=100, angle=30, unit="N", wrt="+x", angle_reference=ref)

    def test_wrt_invalid_direction(self):
        """Test that invalid direction in wrt raises error."""
        with pytest.raises(ValueError, match="Invalid direction"):
            ForceVector(magnitude=100, angle=30, unit="N", wrt="invalid:+x")
    ...
    def test_wrt_invalid_axis_not_in_coordinate_system(self):
        ...
        with pytest.raises(ValueError, match="Invalid wrt axis 'u'"):
            ForceVector(magnitude=100, angle=30, unit="N", wrt="u")
    ...
    def test_wrt_valid_axis_in_custom_coordinate_system(self):
        ...
        F1 = ForceVector(magnitude=100, angle=30, unit="N", wrt="u", coordinate_system=uv_system)
        assert F1.angle_reference.axis_label == "u"

        F2 = ForceVector(magnitude=100, angle=30, unit="N", wrt="cw:v", coordinate_system=uv_system)
    ...
    def test_wrt_invalid_axis_not_in_custom_coordinate_system(self):
        ...
        with pytest.raises(ValueError, match="Invalid wrt axis 'w'"):
            ForceVector(magnitude=100, angle=30, unit="N", wrt="w", coordinate_system=uv_system)
