...
asin = _create_unary_function("asin", "Inverse sine (arcsine) function. Returns angle in radians.")
acos = _create_unary_function("acos", "Inverse cosine (arccosine) function. Returns angle in radians.")
