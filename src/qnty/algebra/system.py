...
class EquationSystem:
    ...
    def __init__(self, equations: list[Equation] | None = None):
        ...
        self.variables: dict[str, FieldQuantity] = {}  # Dict[str, FieldQnty]
    ...
    def add_variable(self, variable: FieldQuantity):
    ...
    def _is_variable_known(self, var: FieldQuantity) -> bool:
