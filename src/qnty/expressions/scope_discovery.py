...
class ScopeDiscoveryService:
    ...
    @classmethod
    def _get_current_frame(cls):
        """Get the current frame for internal use."""
    ...
    def _find_user_frame(cls, current_frame: Any) -> Any | None:
        ...
        internal_files = ("expression.py", "equation.py", "nodes.py", "scope_discovery.py", "expression_quantity.py", "unified_variable.py")
