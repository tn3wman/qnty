...
def sin(expr: Union["Expression", "UnifiedVariable", "Quantity", int, float]) -> UnaryFunction:
    """Sine function."""
    return UnaryFunction("sin", Expression._wrap_operand(expr))


def cos(expr: Union["Expression", "UnifiedVariable", "Quantity", int, float]) -> UnaryFunction:
    """Cosine function."""
    return UnaryFunction("cos", Expression._wrap_operand(expr))


def tan(expr: Union["Expression", "UnifiedVariable", "Quantity", int, float]) -> UnaryFunction:
    """Tangent function."""
    return UnaryFunction("tan", Expression._wrap_operand(expr))


def sqrt(expr: Union["Expression", "UnifiedVariable", "Quantity", int, float]) -> UnaryFunction:
    """Square root function."""
    return UnaryFunction("sqrt", Expression._wrap_operand(expr))


def abs_expr(expr: Union["Expression", "UnifiedVariable", "Quantity", int, float]) -> UnaryFunction:
    """Absolute value function."""
    return UnaryFunction("abs", Expression._wrap_operand(expr))


def ln(expr: Union["Expression", "UnifiedVariable", "Quantity", int, float]) -> UnaryFunction:
    """Natural logarithm function."""
    return UnaryFunction("ln", Expression._wrap_operand(expr))


def log10(expr: Union["Expression", "UnifiedVariable", "Quantity", int, float]) -> UnaryFunction:
    """Base-10 logarithm function."""
    return UnaryFunction("log10", Expression._wrap_operand(expr))


def exp(expr: Union["Expression", "UnifiedVariable", "Quantity", int, float]) -> UnaryFunction:
...
def cond_expr(
    ...
    true_expr: Union["Expression", "UnifiedVariable", "Quantity", int, float],
    false_expr: Union["Expression", "UnifiedVariable", "Quantity", int, float],
...
def min_expr(*expressions: Union["Expression", "UnifiedVariable", "Quantity", int, float]) -> "Expression":
...
def max_expr(*expressions: Union["Expression", "UnifiedVariable", "Quantity", int, float]) -> "Expression":
