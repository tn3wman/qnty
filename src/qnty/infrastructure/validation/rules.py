...
from qnty.domain.expressions import Expression as QntyExpression
...
def add_rule(condition: QntyExpression, message: str, warning_type: str = "VALIDATION", severity: Literal["INFO", "WARNING", "ERROR"] = "WARNING", name: str | None = None) -> Rules:
    """
