...
class CompositionMixin:
    ...
    def _namespace_expression(self, expr, symbol_mapping):
        ...
        """
        from qnty.domain.expressions import BinaryOperation, ConditionalExpression, Constant, VariableReference
    ...
    def _namespace_binary_operation(self, expr, symbol_mapping):
        ...
        from qnty.domain.expressions import BinaryOperation
    ...
    def _namespace_conditional_expression(self, expr, symbol_mapping):
        ...
        from qnty.domain.expressions import ConditionalExpression
