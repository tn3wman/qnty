...
from .core import Unit, UnitNamespace, ureg


class AbsorbedDoseUnits(UnitNamespace):
    """Unit constants for Absorbed Radiation Dose."""

    __slots__ = ()
    __preferred__ = "gray" # Where SI factor is 1.0
...
class AccelerationUnits(UnitNamespace):
    ...
    __slots__ = ()
    __preferred__ = "meter_per_second_squared" # Where SI factor is 1.0
...
class ActivationEnergyUnits(UnitNamespace):
    """Unit constants for Activation Energy."""

    __slots__ = ()
    __preferred__ = "joule_per_gram_mole" # Where SI factor is 1.0
...
class AmountOfSubstanceUnits(UnitNamespace):
    """Unit constants for Amount of Substance."""

    __slots__ = ()
    __preferred__ = "mole" # Where SI factor is 1.0
...
class AnglePlaneUnits(UnitNamespace):
    ...
    __slots__ = ()
    __preferred__ = "radian" # Where SI factor is 1.0
...
class AngleSolidUnits(UnitNamespace):
    """Unit constants for Angle, Solid."""

    __slots__ = ()
    __preferred__ = "steradian" # Where SI factor is 1.0
...
class AngularAccelerationUnits(UnitNamespace):
    """Unit constants for Angular Acceleration."""

    __slots__ = ()
    __preferred__ = "radian_per_second_squared" # Where SI factor is 1.0
...
class AngularMomentumUnits(UnitNamespace):
    """Unit constants for Angular Momentum."""

    __slots__ = ()
    __preferred__ = "kilogram_meter_squared_per_second" # Where SI factor is 1.0
...
class AreaUnits(UnitNamespace):
    ...
    __slots__ = ()
    __preferred__ = "square_meter" # Where SI factor is 1.0
...
class AreaPerUnitVolumeUnits(UnitNamespace):
    """Unit constants for Area per Unit Volume."""

    __slots__ = ()
    __preferred__ = "square_inch_per_cubic_inch" # Where SI factor is 1.0
...
class AtomicWeightUnits(UnitNamespace):
    """Unit constants for Atomic Weight."""

    __slots__ = ()
    __preferred__ = "atomic_mass_unit_12c" # Where SI factor is 1.0
...
class ConcentrationUnits(UnitNamespace):
...
class DimensionlessUnits(UnitNamespace):
    ...
    __slots__ = ()
    __preferred__ = "dimensionless" # Where SI factor is 1.0
...
class DynamicFluidityUnits(UnitNamespace):
    """Unit constants for Dynamic Fluidity."""

    __slots__ = ()
    __preferred__ = "meter_seconds_per_kilogram" # Where SI factor is 1.0
...
class ElectricCapacitanceUnits(UnitNamespace):
    """Unit constants for Electric Capacitance."""

    __slots__ = ()
    __preferred__ = "farad" # Where SI factor is 1.0
...
class ElectricChargeUnits(UnitNamespace):
    """Unit constants for Electric Charge."""

    __slots__ = ()
    __preferred__ = "faraday_c12" # Where SI factor is 1.0
...
class ElectricCurrentIntensityUnits(UnitNamespace):
    """Unit constants for Electric Current Intensity."""

    __slots__ = ()
    __preferred__ = "ampere_or_amp" # Where SI factor is 1.0
...
class ElectricDipoleMomentUnits(UnitNamespace):
    """Unit constants for Electric Dipole Moment."""

    __slots__ = ()
    __preferred__ = "ampere_meter_second" # Where SI factor is 1.0
...
class ElectricFieldStrengthUnits(UnitNamespace):
    """Unit constants for Electric Field Strength."""

    __slots__ = ()
    __preferred__ = "volt_per_meter" # Where SI factor is 1.0
...
class ElectricInductanceUnits(UnitNamespace):
    """Unit constants for Electric Inductance."""

    __slots__ = ()
    __preferred__ = "henry" # Where SI factor is 1.0
...
class ElectricPotentialUnits(UnitNamespace):
    """Unit constants for Electric Potential."""

    __slots__ = ()
    __preferred__ = "volt" # Where SI factor is 1.0
...
class ElectricResistanceUnits(UnitNamespace):
    """Unit constants for Electric Resistance."""

    __slots__ = ()
    __preferred__ = "ohm" # Where SI factor is 1.0
...
class ElectricalConductanceUnits(UnitNamespace):
    """Unit constants for Electrical Conductance."""

    __slots__ = ()
    __preferred__ = "mho" # Where SI factor is 1.0
...
class ElectricalPermittivityUnits(UnitNamespace):
    """Unit constants for Electrical Permittivity."""

    __slots__ = ()
    __preferred__ = "farad_per_meter" # Where SI factor is 1.0
...
class ElectricalResistivityUnits(UnitNamespace):
    """Unit constants for Electrical Resistivity."""

    __slots__ = ()
    __preferred__ = "ohm_meter" # Where SI factor is 1.0
...
class EnergyFluxUnits(UnitNamespace):
    """Unit constants for Energy Flux."""

    __slots__ = ()
    __preferred__ = "watt_per_square_meter" # Where SI factor is 1.0
...
class EnergyHeatWorkUnits(UnitNamespace):
    """Unit constants for Energy, Heat, Work."""

    __slots__ = ()
    __preferred__ = "joule" # Where SI factor is 1.0
...
class EnergyPerUnitAreaUnits(UnitNamespace):
    """Unit constants for Energy per Unit Area."""

    __slots__ = ()
    __preferred__ = "joule_per_square_meter" # Where SI factor is 1.0
...
class ForceUnits(UnitNamespace):
    ...
    __slots__ = ()
    __preferred__ = "newton" # Where SI factor is 1.0
...
class ForceBodyUnits(UnitNamespace):
    """Unit constants for Force (Body)."""

    __slots__ = ()
    __preferred__ = "newton_per_cubic_meter" # Where SI factor is 1.0
...
class ForcePerUnitMassUnits(UnitNamespace):
    """Unit constants for Force per Unit Mass."""

    __slots__ = ()
    __preferred__ = "newton_per_kilogram" # Where SI factor is 1.0
...
class FrequencyVoltageRatioUnits(UnitNamespace):
    """Unit constants for Frequency Voltage Ratio."""

    __slots__ = ()
    __preferred__ = "cycles_per_second_per_volt" # Where SI factor is 1.0
...
class FuelConsumptionUnits(UnitNamespace):
    """Unit constants for Fuel Consumption."""

    __slots__ = ()
    __preferred__ = "kilometers_per_liter" # Where SI factor is 1.0
...
class HeatOfCombustionUnits(UnitNamespace):
    """Unit constants for Heat of Combustion."""

    __slots__ = ()
    __preferred__ = "joule_per_kilogram" # Where SI factor is 1.0
...
class HeatOfFusionUnits(UnitNamespace):
    ...
    heat_british_thermal_unit_mean = Unit(
        name="heat_british_thermal_unit_mean",
        symbol="Btu (mean)/lb",
    ...
    Btu_mean_lb = heat_british_thermal_unit_mean

    # British thermal unit per pound
    heat_british_thermal_unit_per_pound = Unit(
        name="heat_british_thermal_unit_per_pound",
        symbol="Btu/lb",
        dimension=dim.HEAT_OF_FUSION,
        si_factor=2326.0,
        si_offset=0.0,
    ...
    # calorie per gram
    heat_calorie_per_gram = Unit(
        name="heat_calorie_per_gram",
        symbol="$\\mathrm{cal} / \\mathrm{g}$",
        dimension=dim.HEAT_OF_FUSION,
        si_factor=4186.0,
        si_offset=0.0,
    ...
    # Chu per pound
    heat_chu_per_pound = Unit(
        name="heat_chu_per_pound",
        symbol="Chu/lb",
        dimension=dim.HEAT_OF_FUSION,
        si_factor=4186.8,
        si_offset=0.0,
    ...
    # joule per kilogram
    heat_joule_per_kilogram = Unit(
        name="heat_joule_per_kilogram",
        symbol="J/kg",
        dimension=dim.HEAT_OF_FUSION,
        si_factor=1.0,
        si_offset=0.0,
...
class HeatOfVaporizationUnits(UnitNamespace):
    ...
    # British thermal unit per pound
    heat_british_thermal_unit_per_pound_1 = Unit(
        name="heat_british_thermal_unit_per_pound_1",
        symbol="Btu/lb",
    ...
    # calorie per gram
    heat_calorie_per_gram_1 = Unit(
        name="heat_calorie_per_gram_1",
        symbol="$\\mathrm{cal} / \\mathrm{g}$",
        dimension=dim.HEAT_OF_VAPORIZATION,
        si_factor=4186.0,
        si_offset=0.0,
    ...
    # Chu per pound
    heat_chu_per_pound_1 = Unit(
        name="heat_chu_per_pound_1",
        symbol="Chu/lb",
        dimension=dim.HEAT_OF_VAPORIZATION,
        si_factor=4186.8,
        si_offset=0.0,
    ...
    # joule per kilogram
    heat_joule_per_kilogram_1 = Unit(
        name="heat_joule_per_kilogram_1",
        symbol="J/kg",
        dimension=dim.HEAT_OF_VAPORIZATION,
        si_factor=1.0,
        si_offset=0.0,
...
class HeatTransferCoefficientUnits(UnitNamespace):
    """Unit constants for Heat Transfer Coefficient."""

    __slots__ = ()
    __preferred__ = "watt_per_square_meter_per_degree_celsius_or_kelvin" # Where SI factor is 1.0
...
class IlluminanceUnits(UnitNamespace):
    """Unit constants for Illuminance."""

    __slots__ = ()
    __preferred__ = "lux" # Where SI factor is 1.0
...
class KineticEnergyOfTurbulenceUnits(UnitNamespace):
    """Unit constants for Kinetic Energy of Turbulence."""

    __slots__ = ()
    __preferred__ = "square_meters_per_second_squared" # Where SI factor is 1.0
...
class LengthUnits(UnitNamespace):
    ...
    __slots__ = ()
    __preferred__ = "meter" # Where SI factor is 1.0
    ...
    # arpent (Quebec)
    leng_arpent_quebec = Unit(
        name="leng_arpent_quebec",
        symbol="arp",
        dimension=dim.LENGTH,
        si_factor=58.47,
        si_offset=0.0,
...
class LinearMassDensityUnits(UnitNamespace):
    """Unit constants for Linear Mass Density."""

    __slots__ = ()
    __preferred__ = "kilogram_per_meter" # Where SI factor is 1.0
    ...
    t_m_or_MT_m = ton_metric_m
    t_m = ton_metric_m
    MT_m = ton_metric_m


class LinearMomentumUnits(UnitNamespace):
    """Unit constants for Linear Momentum."""

    __slots__ = ()
    __preferred__ = "kilogram_meters_per_second" # Where SI factor is 1.0
...
class LuminanceSelfUnits(UnitNamespace):
    """Unit constants for Luminance (self)."""

    __slots__ = ()
    __preferred__ = "candela_per_square_meter" # Where SI factor is 1.0
...
class LuminousFluxUnits(UnitNamespace):
    """Unit constants for Luminous Flux."""

    __slots__ = ()
    __preferred__ = "candela_steradian" # Where SI factor is 1.0
...
class LuminousIntensityUnits(UnitNamespace):
    """Unit constants for Luminous Intensity."""

    __slots__ = ()
    __preferred__ = "candela" # Where SI factor is 1.0
...
class MagneticFieldUnits(UnitNamespace):
    """Unit constants for Magnetic Field."""

    __slots__ = ()
    __preferred__ = "ampere_per_meter" # Where SI factor is 1.0
...
class MagneticFluxUnits(UnitNamespace):
    """Unit constants for Magnetic Flux."""

    __slots__ = ()
    __preferred__ = "weber" # Where SI factor is 1.0
...
class MagneticInductionFieldStrengthUnits(UnitNamespace):
    """Unit constants for Magnetic Induction Field Strength."""

    __slots__ = ()
    __preferred__ = "tesla" # Where SI factor is 1.0
...
class MagneticMomentUnits(UnitNamespace):
    """Unit constants for Magnetic Moment."""

    __slots__ = ()
    __preferred__ = "joule_per_tesla" # Where SI factor is 1.0
...
class MagneticPermeabilityUnits(UnitNamespace):
    """Unit constants for Magnetic Permeability."""

    __slots__ = ()
    __preferred__ = "henrys_per_meter" # Where SI factor is 1.0
...
class MagnetomotiveForceUnits(UnitNamespace):
    """Unit constants for Magnetomotive Force."""

    __slots__ = ()
    __preferred__ = "ampere" # Where SI factor is 1.0
...
class MassUnits(UnitNamespace):
    """Unit constants for Mass."""

    __slots__ = ()
    __preferred__ = "kilogram" # Where SI factor is 1.0
...
class MassDensityUnits(UnitNamespace):
    ...
    __slots__ = ()
    __preferred__ = "gram_per_cubic_decimeter" # Where SI factor is 1.0
    ...
    mass_pound_avdp = Unit(
        name="mass_pound_avdp",
        symbol="lb/gal",
        dimension=dim.MASS_DENSITY,
        si_factor=119.826,
        si_offset=0.0,
    ...
    lb_gal = mass_pound_avdp

    # pound (mass) per cubic inch
    mass_pound_mass = Unit(
        name="mass_pound_mass",
    ...
    mathrm_lb_mathrm_cu_in_or_mathrm_lb_mathrm_in_3 = mass_pound_mass
    lb_cu_in = mass_pound_mass
    lb_in_3 = mass_pound_mass
    ...
    mathrm_t_mathrm_m_3_or_MT_mathrm_m_3 = ton_metric_m3
    t_m_3 = ton_metric_m3
    MT_m_3 = ton_metric_m3
...
class MassFlowRateUnits(UnitNamespace):
    ...
    __slots__ = ()
    __preferred__ = "kilograms_per_second" # Where SI factor is 1.0
...
class MassFluxUnits(UnitNamespace):
    """Unit constants for Mass Flux."""

    __slots__ = ()
    __preferred__ = "kilogram_per_square_meter_per_second" # Where SI factor is 1.0
...
class MassFractionOfIUnits(UnitNamespace):
    """Unit constants for Mass Fraction of "i"."""

    __slots__ = ()
    __preferred__ = "kilogram_of_i_per_kilogram_total" # Where SI factor is 1.0
...
class MassTransferCoefficientUnits(UnitNamespace):
    ...
    # kilogram per square meter per second
    mass_kilogram_per_square_meter_per_second = Unit(
        name="mass_kilogram_per_square_meter_per_second",
        symbol="$\\mathrm{kg} / \\mathrm{m}^{2} / \\mathrm{s}$",
        dimension=dim.MASS_TRANSFER_COEFFICIENT,
        si_factor=1.0,
        si_offset=0.0,
...
class MolalityOfSoluteIUnits(UnitNamespace):
    """Unit constants for Molality of Solute "i"."""

    __slots__ = ()
    __preferred__ = "gram_moles_of_i_per_kilogram" # Where SI factor is 1.0
...
class MolarConcentrationByMassUnits(UnitNamespace):
    """Unit constants for Molar Concentration by Mass."""

    __slots__ = ()
    __preferred__ = "gram_mole_or_mole_per_gram" # Where SI factor is 1.0
...
class MolarFlowRateUnits(UnitNamespace):
    """Unit constants for Molar Flow Rate."""

    __slots__ = ()
    __preferred__ = "kilogram_mole_or_kmol_per_hour" # Where SI factor is 1.0
...
class MolarFluxUnits(UnitNamespace):
    """Unit constants for Molar Flux."""

    __slots__ = ()
    __preferred__ = "kmol_per_square_meter_per_second" # Where SI factor is 1.0
...
class MolarHeatCapacityUnits(UnitNamespace):
    """Unit constants for Molar Heat Capacity."""

    __slots__ = ()
    __preferred__ = "joule_per_gram_mole_per_kelvin_or_degree_celsius" # Where SI factor is 1.0
...
class MolarityOfIUnits(UnitNamespace):
    """Unit constants for Molarity of "i"."""

    __slots__ = ()
    __preferred__ = "gram_moles_of_i_per_cubic_meter" # Where SI factor is 1.0
...
class MoleFractionOfIUnits(UnitNamespace):
    """Unit constants for Mole Fraction of "i"."""

    __slots__ = ()
    __preferred__ = "gram_mole_of_i_per_gram_mole_total" # Where SI factor is 1.0
...
class MomentOfInertiaUnits(UnitNamespace):
    """Unit constants for Moment of Inertia."""

    __slots__ = ()
    __preferred__ = "kilogram_square_meter" # Where SI factor is 1.0
...
class MomentumFlowRateUnits(UnitNamespace):
    """Unit constants for Momentum Flow Rate."""

    __slots__ = ()
    __preferred__ = "kilogram_meters_per_square_second" # Where SI factor is 1.0
...
class MomentumFluxUnits(UnitNamespace):
    """Unit constants for Momentum Flux."""

    __slots__ = ()
    __preferred__ = "newton_per_square_meter" # Where SI factor is 1.0
...
class NormalityOfSolutionUnits(UnitNamespace):
    """Unit constants for Normality of Solution."""

    __slots__ = ()
    __preferred__ = "gram_equivalents_per_cubic_meter" # Where SI factor is 1.0
...
class ParticleDensityUnits(UnitNamespace):
    """Unit constants for Particle Density."""

    __slots__ = ()
    __preferred__ = "particles_per_cubic_meter" # Where SI factor is 1.0
...
class PercentUnits(UnitNamespace):
...
class PermeabilityUnits(UnitNamespace):
    """Unit constants for Permeability."""

    __slots__ = ()
    __preferred__ = "square_meters" # Where SI factor is 1.0
...
class PhotonEmissionRateUnits(UnitNamespace):
    """Unit constants for Photon Emission Rate."""

    __slots__ = ()
    __preferred__ = "reciprocal_square_meter_second" # Where SI factor is 1.0
...
class PowerPerUnitMassUnits(UnitNamespace):
    """Unit constants for Power per Unit Mass or Specific Power."""

    __slots__ = ()
    __preferred__ = "watt_per_kilogram" # Where SI factor is 1.0
...
class PowerPerUnitVolumeUnits(UnitNamespace):
    """Unit constants for Power per Unit Volume or Power Density."""

    __slots__ = ()
    __preferred__ = "watt_per_cubic_meter" # Where SI factor is 1.0
...
class PowerThermalDutyUnits(UnitNamespace):
    ...
    __slots__ = ()
    __preferred__ = "volt_ampere" # Where SI factor is 1.0
    ...
    powe_british_thermal_unit_mean = Unit(
        name="powe_british_thermal_unit_mean",
    ...
    Btu_mean_hr_or_Btu_hr = powe_british_thermal_unit_mean
    Btu_mean_hr = powe_british_thermal_unit_mean
    Btu_hr = powe_british_thermal_unit_mean

    # British thermal unit (mean) per minute
    powe_british_thermal_unit_mean_1 = Unit(
        name="powe_british_thermal_unit_mean_1",
    ...
    Btu_min_or_Btu_mean_min = powe_british_thermal_unit_mean_1
    Btu_min = powe_british_thermal_unit_mean_1
    Btu_mean_min = powe_british_thermal_unit_mean_1

    # British thermal unit (thermochemical) per hour
    powe_british_thermal_unit_thermochemical = Unit(
        name="powe_british_thermal_unit_thermochemical",
    ...
    Btu_therm_hr_or_Btu_hr = powe_british_thermal_unit_thermochemical
    Btu_therm_hr = powe_british_thermal_unit_thermochemical

    # British thermal unit (thermochemical) per minute
    powe_british_thermal_unit_thermochemical_1 = Unit(
        name="powe_british_thermal_unit_thermochemical_1",
    ...
    mathrm_Btu_mathrm_min_or_Btu_therm_min = powe_british_thermal_unit_thermochemical_1
    Btu_therm_min = powe_british_thermal_unit_thermochemical_1

    # calorie (mean) per hour
    powe_calorie_mean = Unit(
        name="powe_calorie_mean",
        symbol="cal (mean)/hr",
        dimension=dim.POWER_THERMAL_DUTY,
    ...
    cal_mean_hr = powe_calorie_mean

    # calorie (thermochemical) per hour
    powe_calorie_thermochemical = Unit(
        name="powe_calorie_thermochemical",
        symbol="cal (therm)/hr",
        dimension=dim.POWER_THERMAL_DUTY,
    ...
    cal_therm_hr = powe_calorie_thermochemical
...
class PressureUnits(UnitNamespace):
    ...
    # dyne per square centimeter
    pres_dyne_per_square_centimeter = Unit(
        name="pres_dyne_per_square_centimeter",
        symbol="dyn $/ \\mathrm{cm}^{2}$",
        dimension=dim.PRESSURE,
        si_factor=0.1,
        si_offset=0.0,
    ...
    # newton per square meter
    pres_newton_per_square_meter = Unit(
        name="pres_newton_per_square_meter",
        symbol="$\\mathrm{N} / \\mathrm{m}^{2}$",
        dimension=dim.PRESSURE,
        si_factor=1.0,
        si_offset=0.0,
    ...
    # pound force per square foot
    pres_pound_force_per_square_foot = Unit(
        name="pres_pound_force_per_square_foot",
    ...
    PSF_or_psf_or_mathrm_lb_mathrm_f_mathrm_ft_2 = pres_pound_force_per_square_foot
    psf = pres_pound_force_per_square_foot
...
class RadiationDoseEquivalentUnits(UnitNamespace):
    """Unit constants for Radiation Dose Equivalent."""

    __slots__ = ()
    __preferred__ = "sievert" # Where SI factor is 1.0
...
class RadiationExposureUnits(UnitNamespace):
    """Unit constants for Radiation Exposure."""

    __slots__ = ()
    __preferred__ = "coulomb_per_kilogram" # Where SI factor is 1.0
...
class RadioactivityUnits(UnitNamespace):
    """Unit constants for Radioactivity."""

    __slots__ = ()
    __preferred__ = "becquerel" # Where SI factor is 1.0
...
class SecondMomentOfAreaUnits(UnitNamespace):
    ...
    __slots__ = ()
    __preferred__ = "meter_quadrupled" # Where SI factor is 1.0
...
class SecondRadiationConstantPlanckUnits(UnitNamespace):
    """Unit constants for Second Radiation Constant (Planck)."""

    __slots__ = ()
    __preferred__ = "meter_kelvin" # Where SI factor is 1.0
...
class SpecificEnthalpyUnits(UnitNamespace):
    ...
    # British thermal unit (mean) per pound
    spec_british_thermal_unit_mean = Unit(
        name="spec_british_thermal_unit_mean",
        symbol="Btu (mean)/lb",
    ...
    # British thermal unit per pound
    spec_british_thermal_unit_per_pound = Unit(
        name="spec_british_thermal_unit_per_pound",
        symbol="Btu/lb",
        dimension=dim.SPECIFIC_ENTHALPY,
        si_factor=2324.4,
        si_offset=0.0,
    ...
    # calorie per gram
    spec_calorie_per_gram = Unit(
        name="spec_calorie_per_gram",
        symbol="$\\mathrm{cal} / \\mathrm{g}$",
        dimension=dim.SPECIFIC_ENTHALPY,
        si_factor=4186.8,
        si_offset=0.0,
    ...
    # Chu per pound
    spec_chu_per_pound = Unit(
        name="spec_chu_per_pound",
        symbol="Chu/lb",
        dimension=dim.SPECIFIC_ENTHALPY,
        si_factor=4186.8,
        si_offset=0.0,
    ...
    # joule per kilogram
    spec_joule_per_kilogram = Unit(
        name="spec_joule_per_kilogram",
        symbol="J/kg",
        dimension=dim.SPECIFIC_ENTHALPY,
        si_factor=1.0,
        si_offset=0.0,
...
class SpecificGravityUnits(UnitNamespace):
    ...
    # Dimensionless
    spec_dimensionless = Unit(
        name="spec_dimensionless",
        symbol="Dmls",
    ...
    Dmls = spec_dimensionless


class SpecificHeatCapacityConstantPressureUnits(UnitNamespace):
    """Unit constants for Specific Heat Capacity (Constant Pressure)."""

    __slots__ = ()
    __preferred__ = "joules_per_kilogram_per_kelvin_or_degree_celsius" # Where SI factor is 1.0
...
class SpecificLengthUnits(UnitNamespace):
    """Unit constants for Specific Length."""

    __slots__ = ()
    __preferred__ = "meters_per_kilogram" # Where SI factor is 1.0
...
class SpecificSurfaceUnits(UnitNamespace):
    """Unit constants for Specific Surface."""

    __slots__ = ()
    __preferred__ = "square_meter_per_kilogram" # Where SI factor is 1.0
...
class SpecificVolumeUnits(UnitNamespace):
    ...
    __slots__ = ()
    __preferred__ = "cubic_meter_per_kilogram" # Where SI factor is 1.0
...
class StressUnits(UnitNamespace):
    ...
    # dyne per square centimeter
    stre_dyne_per_square_centimeter = Unit(
        name="stre_dyne_per_square_centimeter",
        symbol="dyn/ $\\mathrm{cm}^{2}$",
    ...
    # gigapascal
    stre_gigapascal = Unit(
        name="stre_gigapascal",
        symbol="GPa",
        dimension=dim.STRESS,
        si_factor=1000000000.0,
        si_offset=0.0,
    ...
    # hectopascal
    stre_hectopascal = Unit(
        name="stre_hectopascal",
        symbol="hPa",
        dimension=dim.STRESS,
        si_factor=100.0,
        si_offset=0.0,
    ...
    # kilogram force per square centimeter
    stre_kilogram_force_per_square_centimeter = Unit(
        name="stre_kilogram_force_per_square_centimeter",
        symbol="at or $\\mathrm{kg}_{\\mathrm{f}} / \\mathrm{cm}^{2}$",
        dimension=dim.STRESS,
        si_factor=98067.0,
        si_offset=0.0,
    ...
    # kilogram force per square meter
    stre_kilogram_force_per_square_meter = Unit(
        name="stre_kilogram_force_per_square_meter",
        symbol="$\\mathrm{kg}_{\\mathrm{f}} / \\mathrm{m}^{2}$",
        dimension=dim.STRESS,
        si_factor=9.80665,
        si_offset=0.0,
    ...
    # kip force per square inch
    stre_kip_force_per_square_inch = Unit(
        name="stre_kip_force_per_square_inch",
        symbol="KSI or ksi or kip ${ }_{f} / \\mathrm{in}^{2}$",
        dimension=dim.STRESS,
        si_factor=6894800.0,
        si_offset=0.0,
    ...
    # megapascal
    stre_megapascal = Unit(
        name="stre_megapascal",
        symbol="MPa",
        dimension=dim.STRESS,
        si_factor=1000000.0,
        si_offset=0.0,
    ...
    # newton per square meter
    stre_newton_per_square_meter = Unit(
        name="stre_newton_per_square_meter",
        symbol="$\\mathrm{N} / \\mathrm{m}^{2}$",
        dimension=dim.STRESS,
        si_factor=1.0,
        si_offset=0.0,
    ...
    # ounce force per square inch
    stre_ounce_force_per_square_inch = Unit(
        name="stre_ounce_force_per_square_inch",
        symbol="OSI or osi or $\\mathrm{oz}_{\\mathrm{f}} / \\mathrm{in}^{2}$",
        dimension=dim.STRESS,
        si_factor=430.922,
        si_offset=0.0,
    ...
    oz_f_in_2 = stre_ounce_force_per_square_inch
    ...
    # pound force per square foot
    stre_pound_force_per_square_foot = Unit(
        name="stre_pound_force_per_square_foot",
        symbol="PSF or psf or $\\mathrm{lb}_{\\mathrm{f}} / \\mathrm{ft}^{2}$",
        dimension=dim.STRESS,
        si_factor=47.880259,
        si_offset=0.0,
    ...
    PSF = stre_pound_force_per_square_foot
    lb_f_ft_2 = stre_pound_force_per_square_foot

    # pound force per square inch
    stre_pound_force_per_square_inch = Unit(
        name="stre_pound_force_per_square_inch",
        symbol="psi",
        dimension=dim.STRESS,
        si_factor=6894.757,
        si_offset=0.0,
...
class SurfaceMassDensityUnits(UnitNamespace):
    """Unit constants for Surface Mass Density."""

    __slots__ = ()
    __preferred__ = "kilogram_per_square_meter" # Where SI factor is 1.0
    ...
    surf_pound_mass = Unit(
        name="surf_pound_mass",
    ...
    mathrm_lb_mathrm_ft_2 = surf_pound_mass

    # pound (mass) per square inch
    surf_pound_mass_1 = Unit(
        name="surf_pound_mass_1",
        symbol="$\\mathrm{lb} / \\mathrm{in}^{2}$",
        dimension=dim.SURFACE_MASS_DENSITY,
        si_factor=703.07,
        si_offset=0.0,
...
class SurfaceTensionUnits(UnitNamespace):
    """Unit constants for Surface Tension."""

    __slots__ = ()
    __preferred__ = "newton_per_meter" # Where SI factor is 1.0
...
class TemperatureUnits(UnitNamespace):
    """Unit constants for Temperature."""

    __slots__ = ()
    __preferred__ = "degree_celsius_unit_size" # Where SI factor is 1.0
...
class ThermalConductivityUnits(UnitNamespace):
    """Unit constants for Thermal Conductivity."""

    __slots__ = ()
    __preferred__ = "watt_per_centimeter_per_kelvin" # Where SI factor is 1.0
    ...
    Btu_in_hr_circ_mathrm_F = ther_btu_therm
...
class TimeUnits(UnitNamespace):
    """Unit constants for Time."""

    __slots__ = ()
    __preferred__ = "second" # Where SI factor is 1.0
...
class TorqueUnits(UnitNamespace):
    ...
    __slots__ = ()
    __preferred__ = "newton_meter" # Where SI factor is 1.0
    ...
    # foot poundal
    torq_foot_poundal = Unit(
        name="torq_foot_poundal",
        symbol="ft pdl",
        dimension=dim.TORQUE,
        si_factor=0.04214,
        si_offset=0.0,
    ...
    # newton meter
    torq_newton_meter = Unit(
        name="torq_newton_meter",
        symbol="N m",
        dimension=dim.TORQUE,
        si_factor=1.0,
        si_offset=0.0,
...
class TurbulenceEnergyDissipationRateUnits(UnitNamespace):
    """Unit constants for Turbulence Energy Dissipation Rate."""

    __slots__ = ()
    __preferred__ = "square_meter_per_cubic_second" # Where SI factor is 1.0
...
class VelocityAngularUnits(UnitNamespace):
    """Unit constants for Velocity, Angular."""

    __slots__ = ()
    __preferred__ = "radian_per_second" # Where SI factor is 1.0
...
class VelocityLinearUnits(UnitNamespace):
    ...
    __slots__ = ()
    __preferred__ = "meter_per_second" # Where SI factor is 1.0
...
class ViscosityDynamicUnits(UnitNamespace):
    ...
    __slots__ = ()
    __preferred__ = "dyne_second_per_square_centimeter" # Where SI factor is 1.0
...
class ViscosityKinematicUnits(UnitNamespace):
    ...
    __slots__ = ()
    __preferred__ = "square_meters_per_second" # Where SI factor is 1.0
...
class VolumeUnits(UnitNamespace):
    """Unit constants for Volume."""

    __slots__ = ()
    __preferred__ = "cubic_meter" # Where SI factor is 1.0
...
class VolumeFractionOfIUnits(UnitNamespace):
    """Unit constants for Volume Fraction of "i"."""

    __slots__ = ()
    __preferred__ = "cubic_foot_of_i_per_cubic_foot_total" # Where SI factor is 1.0
...
class VolumetricCalorificHeatingValueUnits(UnitNamespace):
    """Unit constants for Volumetric Calorific (Heating) Value."""

    __slots__ = ()
    __preferred__ = "joule_per_cubic_meter" # Where SI factor is 1.0
...
class VolumetricCoefficientOfExpansionUnits(UnitNamespace):
    """Unit constants for Volumetric Coefficient of Expansion."""

    __slots__ = ()
    __preferred__ = "kilogram_per_cubic_meter_per_kelvin_or_degree_celsius" # Where SI factor is 1.0
...
class VolumetricFlowRateUnits(UnitNamespace):
    ...
    __slots__ = ()
    __preferred__ = "cubic_meters_per_second" # Where SI factor is 1.0
...
class VolumetricFluxUnits(UnitNamespace):
    """Unit constants for Volumetric Flux."""

    __slots__ = ()
    __preferred__ = "cubic_meters_per_square_meter_per_second" # Where SI factor is 1.0
...
class VolumetricMassFlowRateUnits(UnitNamespace):
    """Unit constants for Volumetric Mass Flow Rate."""

    __slots__ = ()
    __preferred__ = "kilogram_per_second_per_cubic_meter" # Where SI factor is 1.0
...
class WavenumberUnits(UnitNamespace):
    """Unit constants for Wavenumber."""

    __slots__ = ()
    __preferred__ = "diopter" # Where SI factor is 1.0
