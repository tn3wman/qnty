...
class ConfigurableVariable:
    ...
    def __init__(self, symbol, name, quantity, is_known=True, proxy=None, original_symbol=None):
        ...
        from optinova.qnty_integration import Dimensionless
...
class DelayedExpression:
    ...
    def resolve(self, context):
        ...
        from optinova.qnty_integration import BinaryOperation
...
class DelayedFunction:
    ...
    def resolve(self, context):
        ...
        from optinova.qnty_integration import sin, min_expr, max_expr
