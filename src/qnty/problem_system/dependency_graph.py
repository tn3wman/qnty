...
class DependencyGraph:
    ...
    def can_solve_system(self, known_vars: Set[str]) -> Tuple[bool, List[str]]:
        ...
        unique_equations = set(self.solvers[var][0] for var in variables_with_solvers if var in self.solvers and self.solvers[var])
    ...
    def get_equation_for_variable(self, var: str, known_vars: Set[str]) -> Optional[Equation]:
