...
from qnty.expression import Expression as QntyExpression
...
class Check:
    ...
    def evaluate(self, variables: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        """
        ...
        try:
            ...
            if hasattr(expr, 'evaluate'):
                ...
                if hasattr(result, 'value'):  # FastQuantity
                    ...
                    try:
                        return float(result_str.split()[0]) > 0.5
