...
from .context import ErrorContext, get_dimension_string, create_context
...
class ErrorHandler:
    ...
    def handle_unit_conversion_error(self, from_unit: str, to_unit: str, reason: str = "", context: Optional[ErrorContext] = None) -> None:
    ...
    def handle_variable_not_found(self, variable_name: str, available_vars: Optional[list[str]] = None, context: Optional[ErrorContext] = None) -> None:
    ...
    def handle_equation_solving_error(self, equation_name: str, target_var: str, reason: str = "", context: Optional[ErrorContext] = None) -> None:
    ...
    def handle_expression_evaluation_error(self, expression: str, reason: str = "", context: Optional[ErrorContext] = None) -> None:
    ...
    def handle_unexpected_error(self, original_error: Exception, operation: str, context: Optional[ErrorContext] = None) -> None:
