from qnty.core.dimension import add_derived, add_dimension
...
ENERGY = add_derived(
    M * L**2 * T**-2,
    aliases=("energy", "HEAT", "heat", "WORK", "work",)
)
FORCE = add_derived(
    M * L * T**-2,
    aliases=("force",)
...
# Export the dim object for use by other modules
from qnty.core.dimension import dim
