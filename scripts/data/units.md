...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
|  |  |  |  | Conversion factor | Unit | Conversion factor | Unit |
| Temperature | degree Celsius (unit size) | $\mathrm{C}^{\circ}$ | $\theta$ | 1 | K | 1.8 | $\mathrm{R}^{\circ}$ |
| Temperature | degree Fahrenheit (unit size) | $\mathrm{F}^{\circ}$ | $\theta$ | 0.555556 | K | 1 | $\mathrm{R}^{\circ}$ |
| Temperature | degree Réaumur (unit size) | Ré ${ }^{\circ}$ | $\theta$ | 1.25 | K | 2.25 | $\mathrm{R}^{\circ}$ |
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
|  |  |  |  | Conversion factor | Unit | Conversion factor | Unit |
| Viscosity, Kinematic | centistokes | cSt | $\mathrm{L}^{2} \mathrm{~T}^{-1}$ | 0.000001 | $\mathrm{m}^{2} / \mathrm{s}$ | $1.0764 \mathrm{E}-05$ | $\mathrm{ft}^{2} / \mathrm{s}$ |
| Viscosity, Kinematic | millistokes | mSt | $\mathrm{L}^{2} \mathrm{~T}^{-1}$ | 0.0000001 | $\mathrm{m}^{2} / \mathrm{s}$ | $1.0764 \mathrm{E}-06$ | $\mathrm{ft}^{2} / \mathrm{s}$ |
| Viscosity, Kinematic | square centimeter per second | $\mathrm{cm}^{2} / \mathrm{s}$ | $\mathrm{L}^{2} \mathrm{~T}^{-1}$ | 0.0001 | $\mathrm{m}^{2} / \mathrm{s}$ | 0.0010764 | $\mathrm{ft}^{2} / \mathrm{s}$ |
| Viscosity, Kinematic | square foot per hour | $\mathrm{ft}^{2} / \mathrm{h}$ or $\mathrm{ft}^{2} / \mathrm{hr}$ | $\mathrm{L}^{2} \mathrm{~T}^{-1}$ | 2.58064E -05 | $\mathrm{m}^{2} / \mathrm{s}$ | 0.00027778 | $\mathrm{ft}^{2} / \mathrm{s}$ |
| Viscosity, Kinematic | square foot per second | $\mathrm{ft}^{2} / \mathrm{s}$ | $\mathrm{L}^{2} \mathrm{~T}^{-1}$ | 0.092903 | $\mathrm{m}^{2} / \mathrm{s}$ | 1.000 | $\mathrm{ft}^{2} / \mathrm{s}$ |
| Viscosity, Kinematic | square meters per second | $\mathrm{m}^{2} / \mathrm{s}$ | $\mathrm{L}^{2} \mathrm{~T}^{-1}$ | 1 | $\mathrm{m}^{2} / \mathrm{s}$ | 10.764 | $\mathrm{ft}^{2} / \mathrm{s}$ |
| Viscosity, Kinematic | stokes | St | $\mathrm{L}^{2} \mathrm{~T}^{-1}$ | 0.0001 | $\mathrm{m}^{2} / \mathrm{s}$ | 0.0010764 | $\mathrm{ft}^{2} / \mathrm{s}$ |
