...
class DimensionGenerator:
    ...
    def generate_header(self) -> list[str]:
        ...
        lines = [
            ...
            "",
            "This file is auto-generated by codegen/generators/field_dims.py",
    ...
    def generate_dimension_constants(self) -> list[str]:
        ...
        # Lazy loading infrastructure with proper type hints
        lines.extend(
            [
                "# Immutable lazy loading cache",
                "_dimension_cache: Dict[str, DimensionSignature] = {}",
                "",
                "",
                "def __getattr__(name: str) -> DimensionSignature:",
                '    """Lazy load dimension constants with caching."""',
